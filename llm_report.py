...
def _build_prompt(timeframes_config, all_timeframes):
    ...
    system_prompt = (
        ...
        "swell size.\n"
        "- Attack angle: the angle the swell hits the beach face. A 15-45\u00b0 wave angle "
        "peels beautifully. Straight-on wave angle closes out. Extreme wave angle means "
        "the wave arrives weak after refracting along the coast.\n"
