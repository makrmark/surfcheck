...
def _build_prompt(timeframes_config, all_timeframes):
    ...
    system_prompt = (
        ...
        "swell size.\n"
        "- Attack angle: the angle the swell hits the beach face. 15-45\u00b0 peels beautifully. "
        "Straight-on closes out. Extreme angle means the wave arrives weak after refracting.\n"
